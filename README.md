Just copy the .h and .c on your directory, initialize the kalman and/or mean variables, and call the functions, done!, R and Q values must be the equivalent of float * 65536
